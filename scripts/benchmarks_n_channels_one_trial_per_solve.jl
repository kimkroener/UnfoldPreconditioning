...
# ----
results_dir = joinpath(@__DIR__, "../tmp/benchmark_testcase_medium_one_trial_per_solve/")
mkpath(results_dir)

run_benchmarks_full_solve(
    solvers,
    preconditioners,
    n_channels,
    testcase;
    ...
    final_csv_name = "bm_$(testcase[1])_nchannels-$(join(n_channels, "-")).csv",
)
